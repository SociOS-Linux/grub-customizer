...
public:
	PartitionChooser_DropDown(Glib::ustring const& activePartition_uuid, DeviceDataList_Iface const& deviceDataList, bool prependCurrentPartition = false, std::string const& currentPartitionName = "");
	void load();

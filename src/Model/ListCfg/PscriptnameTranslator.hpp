...
namespace Gc { namespace Model { namespace ListCfg { class PscriptnameTranslator
{
	public: static std::string decode(std::string const& input)
	{
	...
	public: static std::string encode(std::string const& input, int x)
	{

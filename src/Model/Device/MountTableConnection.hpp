...
{
	protected: std::shared_ptr<Gc::Model::Device::MountTable> mountTable;

	public: void setMountTable(std::shared_ptr<Gc::Model::Device::MountTable> mountTable)
	{
...
#endif /* SRC_MODEL_DEVICE_MOUNTTABLECONNECTION_HPP_ */
